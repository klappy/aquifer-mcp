...
**O32: Existing telemetry tracked tool invocations but not what was being accessed.**
...
**O33: Tool arguments contain structural identifiers safe for telemetry extraction.**
...
**O34: Search queries can be classified by pattern without logging the raw text.**
...
**D24: Extract resource_code, language, content_id, and search type from tool arguments in the telemetry recording path.**
...
**D25: Bump schema version to telemetry-public-v2.**
